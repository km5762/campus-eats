...
function ContentContainer(_a) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_1___default().createElement((react__WEBPACK_IMPORTED_MODULE_1___default().Fragment), null,
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Routes, null,
            react__WEBPACK_IMPORTED_MODULE_1___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Route, { path: "/campus/7/locations", element: react__WEBPACK_IMPORTED_MODULE_1___default().createElement(LocationContentContainer, null) }),
            react__WEBPACK_IMPORTED_MODULE_1___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Route, { path: "/campus/7/locations/:locationID/dishes", element: react__WEBPACK_IMPORTED_MODULE_1___default().createElement(DishContentContainer, null) })),
...
function LocationCard(_a) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", { className: "location" },
        ...
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Link, { to: "/campus/7/locations/".concat(id, "/dishes") }, "See all ".concat(count, " dishes"))));
}
