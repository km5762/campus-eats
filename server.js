...
function DishCard(_a) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "dish" },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "top-half" },
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Rating, { name: "read-only", value: rating, precision: 0.25, sx: { svg: { width: "clamp(16px, 4vw, 24px)" } }, readOnly: true })),
...
function LocationCard(_a) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", { className: "location" },
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement("span", { className: "name" }, name),
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", { className: "rating-container" },
            ...
            react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_0__.Rating, { name: "read-only", value: notStacked ? 1 : rating, max: notStacked ? 1 : 5, precision: 0.25, sx: smallScreen ? { svg: { width: "4vw" } } : undefined, readOnly: true })),
