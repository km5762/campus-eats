...
function ReviewCard(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_0__.Paper, {
    ...
    variant: "caption",
    fontSize: "1.25rem"
  }, placeHolderVote === true ? likes + 1 : placeHolderVote === false ? likes - 1 : likes)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_0__.Tooltip, {
    title: "Not Helpful"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_0__.IconButton, {
...
function UserVotesStoreProvider(_ref) {
  ...
  function syncVotes() {
    ...
    if (reviewIDs.length > 0) {
      ...
      for (var _i2 = 0, _Object$entries = Object.entries(userVotesStore); _i2 < _Object$entries.length; _i2++) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    ...
    var _supabaseClient$auth$ = _services_supabaseClient__WEBPACK_IMPORTED_MODULE_1__.supabaseClient.auth.onAuthStateChange(function (event) {
        if (event === "SIGNED_OUT") {
          syncVotes();
          clearVotes();
        }
...
_supabaseClient__WEBPACK_IMPORTED_MODULE_1__.supabaseClient.auth.onAuthStateChange(function (event) {
