...
function ContentContainer(_a) {
    ...
    function handleLocationCardClick(id, name) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0,_services_api__WEBPACK_IMPORTED_MODULE_2__.fetchDishes)(id)];
                    case 1:
                        res = _a.sent();
    ...
    return (react__WEBPACK_IMPORTED_MODULE_1___default().createElement((react__WEBPACK_IMPORTED_MODULE_1___default().Fragment), null,
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_BreadCrumbs__WEBPACK_IMPORTED_MODULE_3__["default"], { breadCrumbs: breadCrumbs, setContentArray: setContentArray, setContentClass: setContentClass, setBreadCrumbs: setBreadCrumbs }),
